...
namespace hpx { namespace util { namespace detail
{
    ...
    struct serializable_function_vtable
      : VTablePtr, serializable_vtable
    {
        char const* name;

        template <typename T>
        BOOST_CONSTEXPR serializable_function_vtable(construct_vtable<T>) BOOST_NOEXCEPT
    ...
    struct serializable_function_registration
    {
        typedef serializable_function_vtable<VTablePtr> first_type;
